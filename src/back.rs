...
static N: usize = 256;
static Q: i64 = 8380417;

// fn main() {
//     let mut p:[i64;256] = [1;256];
//     println!("ntt");
//     ntt(&mut p);
//     println!("ntt domin: {:?}", p);
//     println!("intt");
//     intt(&mut p);
//     println!("normal domin: {:?}", p);
// }

fn ntt(poly: &mut [i64; 256]) {
    let mut i: usize = 128;
    let mut j: usize;
    let mut k: usize;
    let mut ind = 0;
    ...
    loop {
        ...
        loop {
            ...
            loop {
                ...
                let twiddle = zeta * poly[k + i] % Q;
                poly[k + i] = (poly[k] - twiddle) % Q;
                poly[k] = (poly[k] + twiddle) % Q;
                k += 1;
            }
            j += 2 * i;
        }
    ...
    loop {
        ...
        loop {
            ...
            loop {
                ...
                let temp = poly[k];
                poly[k] = (poly[k] + poly[k + i]) % Q;
                poly[k + i] = (temp - poly[k + i]) % Q;
                poly[k + i] = (zeta * poly[k + i]) % Q;
                k += 1;
            }
            j += 2 * i;
        }
