...
static ZETAS: [i32; 255] = [
    4808194, 3765607, 3761513, 5178923, 5496691, 5234739, 5178987, 7778734, 3542485, 2682288,
...
impl Poly {
    ...
    pub fn point_wise_mul(&mut self, b: &mut Poly) -> () {
        let mut i: usize = 0;
        loop {
            ...
            loop {
                ...
                loop {
                    ...
                    self.coeffs[start + i + len] =
                        temp + montgomery_reduce(self.coeffs[start + i + len] as i64 * zeta as i64);
                    i += 1;
                    if i == len {
                        break;
                    }
